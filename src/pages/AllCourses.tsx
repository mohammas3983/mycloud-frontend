...
      >
        {/* Header + Search - ✅ کاملاً صاف */}
        <motion.div
          initial={{ opacity: 0, y: -20 }} // انیمیشن ورود عمودی ساده
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          // ✅ هیچ استایل چرخشی (rotate/skew) در اینجا یا در CSS نیست
...
              <motion.span
                // انیمیشن کوچک روی آیکون کتاب را حفظ می‌کنیم اما از چرخش کل هدر جلوگیری می‌کنیم
